...
{
    public delegate ICheatRuntimeWidget CreateCheatWidgetDelegate(ICheat cheat);
    public delegate void DisposeCheatWidgetDelegate(ICheatRuntimeWidget cheatWidget);

...
{
    public class NextPreviousCheatWidget<T> : ICheatWidget
    {
        private readonly NextPreviousCheat<T> nextPreviousCheat;
        private readonly NextPreviousCheatWidgetReferences references;

        private T previousValue;

        public GameObject GameObject => references.gameObject;

        public NextPreviousCheatWidget(
            NextPreviousCheat<T> nextPreviousCheat,
            NextPreviousCheatWidgetReferences commonNextPreviousCheatWidget
            )
        {
